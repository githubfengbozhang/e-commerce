  ...
  <div>
    ...
    <div class="flex">
      <div class="circular-max">
        <div class="text">
          <div>视频监控</div>
          <div class="mt10"><span class="name">设备总数：</span><span class="number">6</span><span>(个)</span></div>
          <div class="mt10"><span class="name">设备异常：</span><span class="number">6</span><span>(个)</span></div>
